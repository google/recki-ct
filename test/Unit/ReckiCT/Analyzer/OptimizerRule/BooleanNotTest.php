...
/**
 * @coversDefaultClass \ReckiCT\Analyzer\OptimizerRule\BooleanNot
 */
class BooleanNotTest extends TestCase
{
    /**
     * @covers ::process
     */
    ...
    {
        $rule = new BooleanNot();
        $vertex = new JitBooleanNot($a = new Variable(new Type(Type::TYPE_LONG)), $r = new Variable());
    ...
    {
        $rule = new BooleanNot();
        $vertex = new JitBooleanNot($a = new Variable(new Type(Type::TYPE_LONG)), $r = new Variable(new Type(Type::TYPE_DOUBLE)));
